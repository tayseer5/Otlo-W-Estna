...
public class SkillsManager implements AfterAsynchronous {
    ...
    public void getSkills(int code) {
        ...
        getSkillsConnection.RequestService(URLManager.skillsURl, null, this.code, null, URLManager.getConnectionType);
    }
    ...
    private void getSkillsProcess(String response, int resMsg)
    {
        switch (resMsg) {
